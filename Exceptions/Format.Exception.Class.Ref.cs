...
namespace GalacticShrine.Exceptions {
	...
	/**
	 * <summary>
	 *   [FR] Exception levée lorsqu'une valeur ne respecte pas le format attendu.
	 *   [EN] Exception thrown when a value does not match the expected format.
	 * </summary>
	 **/
	[Serializable]
	public class GsFormatException : FormatException {
		 ...
		 * </summary>
		 **/
		private static readonly string MessageParDefaut = Resources.MessageExceptionLeFormatFourniEstInvalide;

		/**
		 * <summary>
		 *   [FR] Initialise une nouvelle instance avec un message par défaut.
		 *   [EN] Initializes a new instance with a default message.
		 * </summary>
		 **/
		public GsFormatException() : base(MessageParDefaut) {

		}

		/**
		 * <summary>
		 *   [FR] Initialise une nouvelle instance avec un message personnalisé.
		 *   [EN] Initializes a new instance with a custom message.
		 * </summary>
		 * <param name="Message">
		 *   [FR] Message décrivant l'erreur de format.
		 *   [EN] Message describing the format error.
		 * </param>
		 **/
		public GsFormatException(string? Message) : base(NormaliserLeMessage(Message)) {
		 ...
		 * </param>
		 **/
		public GsFormatException(string? Format, params object?[] Arguments) : base(FormaterLeMessage(Format, Arguments)) {
		 ...
		 *   [FR] Exception interne ayant provoqué cette erreur.
		 *   [EN] Inner exception that caused this error.
		 * </param>
		 **/
		public GsFormatException(string? Message, Exception? ExceptionInterne) : base(NormaliserLeMessage(Message), ExceptionInterne) {
		 ...
		 * </param>
		 **/
		public GsFormatException(Exception? ExceptionInterne, string? Format, params object?[] Arguments) 
		 ...
		 * </param>
		 * <param name="Contexte">
		 *   [FR] Contexte de la sérialisation.
		 *   [EN] Streaming context.
		 * </param>
		 **/
#pragma warning disable SYSLIB0051
		protected GsFormatException(SerializationInfo Info, StreamingContext Contexte) : base(Info, Contexte) {
...
#pragma warning restore SYSLIB0051
		 ...
		 * </summary>
		 **/
		private static string NormaliserLeMessage(string? Message) {

			return string.IsNullOrWhiteSpace(Message) ? MessageParDefaut : Message;
		}
	}
}
