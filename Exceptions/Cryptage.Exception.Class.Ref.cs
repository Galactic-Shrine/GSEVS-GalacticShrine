...
namespace GalacticShrine.Exceptions {
	...
	/**
	 * <summary>
	 *   [FR] Exception de base pour les erreurs spécifiques au module GalacticShrine.Cryptage.
	 *   [EN] Base exception type for GalacticShrine.Cryptage-specific errors.
	 * </summary>
	 **/
	[Serializable]
	public class GsCryptageException : CryptographicException {
		 ...
		 * </summary>
		 **/
		private static readonly string  MessageParDefaut = Resources.MessageExceptionUneErreurDeCryptageSEstProduite;
		 ...
		 * </summary>
		 **/
		public GsCryptageException() : base(MessageParDefaut) {
		 ...
		 * </param>
		 **/
		public GsCryptageException(string? Message) : base(NormaliserLeMessage(Message)) {
		 ...
		 * </param>
		 **/
		public GsCryptageException(string? Format, params object?[] Arguments) : base(FormaterLeMessage(Format, Arguments)) {
		 ...
		 * </param>
		 **/
		public GsCryptageException(string? Message, Exception? ExceptionInterne) : base(NormaliserLeMessage(Message), ExceptionInterne) {
		 ...
		 * </param>
		 **/
		public GsCryptageException(Exception? ExceptionInterne, string? Format, params object?[] Arguments) 
...
#pragma warning disable SYSLIB0051
		protected GsCryptageException(SerializationInfo Info, StreamingContext Contexte) : base(Info, Contexte) {
