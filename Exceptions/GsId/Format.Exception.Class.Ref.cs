...
namespace GalacticShrine.Exceptions.GsId {
	 ...
	 **/
	[Serializable]
	public class GsIdFormatException : GsFormatException {
		 ...
		 * </summary>
		 **/
		private static readonly string MessageParDefaut = Resources.MessageExceptionLeFormatDuGsIdEstInvalide;
		 ...
		 * </summary>
		 **/
		public GsIdFormatException() : base(MessageParDefaut) {
		 ...
		 * </param>
		 **/
		public GsIdFormatException(string? Message) : base(NormaliserLeMessage(Message)) {
		 ...
		 * </param>
		 **/
		public GsIdFormatException(string? Format, params object?[] Arguments) : base(FormaterLeMessage(Format, Arguments)) {
		 ...
		 * </param>
		 **/
		public GsIdFormatException(string? Message, Exception? ExceptionInterne) : base(NormaliserLeMessage(Message), ExceptionInterne) {
		 ...
		 * </param>
		 **/
		public GsIdFormatException(Exception? ExceptionInterne, string? Format, params object?[] Arguments) 
		 ...
		 * </summary>
		 **/
		protected GsIdFormatException(SerializationInfo Info, StreamingContext Contexte) : base(Info, Contexte) {
