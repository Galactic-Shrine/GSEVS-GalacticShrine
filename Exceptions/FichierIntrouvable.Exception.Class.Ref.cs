...
namespace GalacticShrine.Exceptions {
	...
	/**
	 * <summary>
	 *   [FR] Exception levée lorsqu'un fichier est introuvable.
	 *   [EN] Exception thrown when a file cannot be found.
	 * </summary>
	 **/
	[Serializable]
	public class GsFichierIntrouvableException : FileNotFoundException {
		 ...
		 * </summary>
		 **/
		private static readonly string MessageParDefaut = Resources.MessageExceptionLeFichierEstIntrouvable;
		 ...
		 * </summary>
		 **/
		public GsFichierIntrouvableException() : base(MessageParDefaut) {
		 ...
		 * </param>
		 **/
		public GsFichierIntrouvableException(string? Message) : base(NormaliserLeMessage(Message)) {
		 ...
		 * </param>
		 **/
		public GsFichierIntrouvableException(string? Format, params object?[] Arguments) : base(FormaterLeMessage(Format, Arguments)) {

		}

		/**
		 * <summary>
		 *   [FR] Crée une nouvelle instance avec un message personnalisé et le nom du fichier.
		 *   [EN] Creates a new instance with a custom message and the file name.
		 * </summary>
		 * <param name="Message">
		 *   [FR] Message décrivant l'erreur.
		 *   [EN] Message describing the error.
		 * </param>
		 * <param name="NomDeFichier">
		 *   [FR] Nom du fichier introuvable.
		 *   [EN] Name of the missing file.
		 * </param>
		 **/
		public GsFichierIntrouvableException(string? Message, string? NomDeFichier) : base(NormaliserLeMessage(Message), NomDeFichier) {

		}

		/**
		 * <summary>
		 *   [FR] Crée une nouvelle instance avec un message formaté via string.Format et le nom du fichier.
		 *   [EN] Creates a new instance with a message formatted through string.Format and the file name.
		 * </summary>
		 * <param name="Message">
		 ...
		 * </param>
		 **/
		public GsFichierIntrouvableException(string? Message, string? NomDeFichier, params object?[] Arguments) 
			: base(FormaterLeMessage(Message, Arguments), NomDeFichier) {
		 ...
		 * </param>
		 **/
		public GsFichierIntrouvableException(string? Message, Exception? ExceptionInterne) : base(NormaliserLeMessage(Message), ExceptionInterne) {
		 ...
		 * </param>
		 **/
		public GsFichierIntrouvableException(Exception? ExceptionInterne, string? Format, params object?[] Arguments) 
		...
		/**
		 * <summary>
		 *   [FR] Crée une nouvelle instance avec un message personnalisé, le nom du fichier et une exception interne.
		 *   [EN] Creates a new instance with a custom message, the file name, and an inner exception.
		 * </summary>
		 * <param name="Message">
		 *   [FR] Message décrivant l'erreur.
		 *   [EN] Message describing the error.
		 ...
		 * </param>
		 **/
		public GsFichierIntrouvableException(string? Message, string? NomDeFichier, Exception? ExceptionInterne) 
			: base(NormaliserLeMessage(Message), NomDeFichier, ExceptionInterne) {

		}

		/**
		 * <summary>
		 *   [FR] Crée une nouvelle instance avec un message formaté via string.Format, le nom du fichier et une exception interne.
		 *   [EN] Creates a new instance with a message formatted through string.Format, the file name, and an inner exception.
		 * </summary>
		 * <param name="Message">
		 *   [FR] Format du message décrivant l'erreur.
		 *   [EN] Format of the message describing the error.
		 ...
		 * </param>
		 **/
		public GsFichierIntrouvableException(string? Message, string? NomDeFichier, Exception? ExceptionInterne, params object?[] Arguments) 
			: base(FormaterLeMessage(Message, Arguments), NomDeFichier, ExceptionInterne) {
...
#pragma warning disable SYSLIB0051
		protected GsFichierIntrouvableException(SerializationInfo Info, StreamingContext Contexte) : base(Info, Contexte) {
