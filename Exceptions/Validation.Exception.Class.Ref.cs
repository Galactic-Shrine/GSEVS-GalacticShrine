...
namespace GalacticShrine.Exceptions {
	...
	/**
	 * <summary>
	 *   [FR] Exception levée lorsqu'une validation échoue.
	 *   [EN] Exception thrown when validation fails.
	 * </summary>
	 **/
	[Serializable]
	public class GsValidationException : ValidationException {
		 ...
		 * </summary>
		 **/
		private static readonly string MessageParDefaut = Resources.MessageExceptionLaValidationAEchoue;
		 ...
		 * </summary>
		 **/
		public GsValidationException() : base(MessageParDefaut) {
		 ...
		 * </summary>
		 * <param name="Message">
		 *   [FR] Message décrivant l'erreur de validation.
		 *   [EN] Message describing the validation error.
		 * </param>
		 **/
		public GsValidationException(string? Message) : base(NormaliserLeMessage(Message)) {
		 ...
		 * </param>
		 **/
		public GsValidationException(string? Format, params object?[] Arguments) : base(FormaterLeMessage(Format, Arguments)) {
		 ...
		 * </param>
		 **/
		public GsValidationException(string? Message, Exception? ExceptionInterne) : base(NormaliserLeMessage(Message), ExceptionInterne) {
		 ...
		 * </param>
		 **/
		public GsValidationException(Exception? ExceptionInterne, string? Format, params object?[] Arguments) 
...
#pragma warning disable SYSLIB0051
		protected GsValidationException(SerializationInfo Info, StreamingContext Contexte) : base(Info, Contexte) {
