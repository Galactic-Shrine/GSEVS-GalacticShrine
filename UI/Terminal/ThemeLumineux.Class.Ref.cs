...
namespace GalacticShrine.UI.Terminal {
  ...
  /**
   * <summary>
   *   [FR] Implémentation d'un thème clair (couleurs claires en arrière-plan).
   *   [EN] Implementation of a light theme (light background colors).
   * </summary>
   **/
  public class ThemeLumineux : ThemeParams {
    ...
    /**
     * <summary>
     *   [FR] Constructeur du thème lumineux. Initialise et configure les couleurs et composants.
     *   [EN] Light theme constructor. Initializes and configures colors and components.
     * </summary>
     * <param name="bConsoleDefault">
     *   [FR] Si <c>true</c>, utilise les couleurs par défaut de la console. Sinon, couleurs personnalisées.
     *   [EN] If <c>true</c>, uses the console's default colors. Otherwise, uses custom colors.
     * </param>
     **/
    ...
    /**
     * <summary>
     *   [FR] Définit les couleurs principales du thème lumineux, soit par défaut console, soit en clair.
     *   [EN] Defines the main colors of the light theme, either console default or light colors.
     * </summary>
     **/
    ...
    /**
     * <summary>
     *   [FR] Configure les différents composants (textes, fonds) avec des couleurs claires.
     *   [EN] Configures the various components (text, background) with light-oriented colors.
     * </summary>
     **/
